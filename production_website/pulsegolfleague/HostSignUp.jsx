...
export default function HostSignUp({ onBack }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setErrorMsg('');
    try {
      const res = await fetch(`${API_BASE}/api/host-housing/host`, {
        method: 'POST',
    ...
    <div className="contact-page">
      ...
      <div className="contact-body">
        <div className="contact-intro">
          <span className="founders-eyebrow">YOLO FLIERS CLUB MEMBERS</span>
          <h1 className="contact-title">Host Housing Sign-Up</h1>
          <p className="contact-subtitle">
            Thank you for opening your home to PGL players this September. Let us know how many
            players you can accommodate and for which dates, and we'll be in touch with the details.
          </p>
        ...
        <div className="contact-form-wrap">
          {status === 'success' ? (
            <div className="contact-success">
              ...
              <h2>Thank you!</h2>
              <p>We've received your host housing sign-up and will reach out with next steps.</p>
            </div>
          ) : (
            <form className="contact-form" onSubmit={handleSubmit} noValidate>
              ...
              <div className="contact-field">
                <label htmlFor="host-capacity">Players You Can Host</label>
                <input
                  id="host-capacity"
                  name="capacity"
                  type="number"
              ...
              <div className="contact-field">
                <label htmlFor="host-notes">Notes (optional)</label>
                <textarea
                  id="host-notes"
                  name="notes"
                  rows={4}
